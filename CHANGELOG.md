...
- The inbox UI and the container image are not implemented yet. Inbox list/get/delete/wait/extract exist on `app.Service`, native `/v1`, `mail_*` MCP tools, and maildev `/email` compat.
