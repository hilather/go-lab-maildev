...
- MCP, auth, UI, maildev `/email` compat, and the container image are not implemented yet. Inbox list/get/delete/wait/extract exist on `app.Service` and native `/v1`.
