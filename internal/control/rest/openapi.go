...
func RenderOpenAPI() ([]byte, error) {
	doc := map[string]any{
		...
		"info": map[string]any{
			"title":          "LabMail Management API",
			"version":        capabilities.VersionTag,
			"description":    "REST adapter for the shared LabMail capability registry. Generated from internal/capabilities. Do not edit by hand.",
...
func openAPIOperation(c capabilities.Capability, b capabilities.RESTBinding) map[string]any {
	...
	if b.Path == "/v1/messages" && strings.EqualFold(b.Method, "GET") {
		params, _ := op["parameters"].([]any)
		params = append(params,
			map[string]any{"name": "to", "in": "query", "schema": map[string]any{"type": "string"}},
			map[string]any{"name": "from", "in": "query", "schema": map[string]any{"type": "string"}},
			map[string]any{"name": "subject", "in": "query", "schema": map[string]any{"type": "string"}},
			map[string]any{"name": "subjectContains", "in": "query", "schema": map[string]any{"type": "string"}},
			map[string]any{"name": "unread", "in": "query", "schema": map[string]any{"type": "boolean"}},
			map[string]any{"name": "after", "in": "query", "schema": map[string]any{"type": "string", "format": "date-time"}},
			map[string]any{"name": "before", "in": "query", "schema": map[string]any{"type": "string", "format": "date-time"}},
	...
	if b.Path == "/v1/messages/{id}" && strings.EqualFold(b.Method, "GET") {
		params, _ := op["parameters"].([]any)
		params = append(params, map[string]any{
			"name":        "markRead",
			"in":          "query",
			"description": "Native default is false. Compat GET /email/:id marks read.",
...
func specSchema() map[string]any {
	return map[string]any{
		"type":        "object",
		"description": "labmail.dev/v1alpha1 LabMail document.",
		"required":    []any{"apiVersion", "kind", "spec"},
		"properties": map[string]any{
			"apiVersion": map[string]any{"type": "string", "const": model.APIVersionV1Alpha1},
			"kind":       map[string]any{"type": "string", "const": model.KindLabMail},
