...
help:
	@printf '%s\n' \
		...
		'  generate            write api/capabilities/v1.json, api/openapi/v1.json, api/mcp/v1.json, and api/metrics/v1alpha1.json' \
		...
		'  web-test            Vitest inbox SPA tests' \
...
test-fuzz-smoke:
	...
	$(GO) test ./internal/mimeparse -fuzz=FuzzParse -fuzztime=5s -count=1
