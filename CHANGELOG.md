...
- Auth, UI, and the container image are not implemented yet. Inbox list/get/delete/wait/extract exist on `app.Service`, native `/v1`, maildev `/email` compat, and `mail_*` MCP tools.
