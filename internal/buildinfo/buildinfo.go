...
const (
	ConfigAPIVersion = "labmail.dev/v1alpha1"
	RESTPrefix       = "/v1"
...
func (i Info) String() string {
	return fmt.Sprintf("labmail %s commit=%s built=%s config=%s rest=%s mcp=%s compat=%s",
		i.Version, i.Commit, i.BuildTime, i.Protocols.ConfigAPI, i.Protocols.REST, i.Protocols.MCP, i.Protocols.Compat)
}
