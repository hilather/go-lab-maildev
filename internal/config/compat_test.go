...
var expectedInvalid = map[string]string{
	...
	"reserved-outgoing.yaml":         violationReservedName,
	"reserved-auto-relay.yaml":       violationReservedName,
	"reserved-auto_relay.yaml":       violationReservedName,
	"reserved-relay.yaml":            violationReservedName,
	"reserved-smarthost.yaml":        violationReservedName,
	"reserved-forwardTo.yaml":        violationReservedName,
	"implicit-tls.yaml":              violationInvalidValue,
	"required-without-starttls.yaml": violationInvalidValue,
	"starttls-missing-cert.yaml":     violationRequired,
	"max-message-bytes-zero.yaml":    violationInvalidValue,
	"smtp-behavior-reply.yaml":       violationInvalidValue,
	"smtp-behavior-verb.yaml":        violationInvalidValue,
	"smtp-behavior-delay.yaml":       violationInvalidValue,
	"smtp-behavior-reply-crlf.yaml":  violationInvalidValue,
